# Accessibility Statement – Codex Variance Waterfall

## Overview
This document outlines the accessibility compliance of the **Codex Variance Waterfall** Power BI custom visual.
...
## 7. Summary
**Codex Variance Waterfall** meets Microsoft's accessibility requirements and is designed to be usable by all users, including those relying on assistive technologies.